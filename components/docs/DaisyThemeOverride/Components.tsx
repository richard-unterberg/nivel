/** biome-ignore-all lint/a11y/useButtonType: example */
    ...
    <div className="not-prose text-base-content mx-auto grid gap-3 xl:gap-4 pb-20 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 [&>*]:mb-6">
          ...
          <div className="card-body gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-base-content/60 flex items-center gap-2 px-1 text-[0.6875rem]">
                <span className="status status-error inline-block"></span> Password must be 8+ characters
              </span>
            </div>
            <label className="text-base-content/60 flex items-center gap-2 text-xs">
              <input type="checkbox" className="toggle toggle-xs" /> Accept terms without reading
            </label>
            <label className="text-base-content/60 flex items-center gap-2 text-xs">
              <input type="checkbox" className="toggle toggle-xs" /> Subscribe to spam emails
            </label>
      ...
      <div className="flex flex-col gap-4">
          ...
          <div className="stats bg-base-100 w-full overflow-hidden shadow-[0_.1rem_.5rem_-.3rem_#0003]">
            <div className="stat">
              <div className="stat-figure">
                <div className="radial-progress [--size:3rem] [--value:91]" role="progressbar">
                  91
                </div>
              </div>
          ...
          <div className="card-body gap-4">
            ...
            <div className="flex flex-col text-xs">
              <div className="border-t-base-content/5 flex items-center justify-between gap-2 border-t border-dashed py-2">
                Charlie Chapman <span className="badge badge-xs badge-info">Send</span>
              </div>
              <div className="border-t-base-content/5 flex items-center justify-between gap-2 border-t border-dashed py-2">
                Howard Hudson <span className="badge badge-xs badge-error">Failed</span>
              </div>
              <div className="border-t-base-content/5 flex items-center justify-between gap-2 border-t border-dashed py-2">
                Fiona Fisher
        ...
        <div className="card bg-base-100 card-border border-base-300 w-full">
          <div className="stats">
            <div className="stat">
              <div className="stat-title">März Revenue</div>
          ...
          <ul className="menu w-full">
            ...
            <li>
              <span>
                ...
                Databases <span className="badge justify-self-end">7</span>
              </span>
            </li>
            <li>
              <span>
            ...
            <li>
              <span>
                ...
                Messages <span className="badge justify-self-end">29</span>
              </span>
            </li>
            <li>
              <span>
            ...
            <li>
              <span>
                ...
                Users <span className="status status-info"></span>
              </span>
            </li>
            <li>
              <span>
      ...
      <div className="flex flex-col gap-4">
        <div className="card bg-base-100 card-border border-base-300 card-sm overflow-hidden">
          ...
          <div className="border-base-300 flex flex-col border-t px-6 py-4">
            <div className="relative mt-6">
              <div
                className="tooltip tooltip-open absolute top-2 before:text-xs [inset-inline-start:10%]"
                data-tip="13:39"
              ></div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="alert alert-soft max-sm:alert-vertical alert-error text-xs font-bold">
            ...
            Access denied <button className="btn btn-xs btn-ghost">Support</button>
          </div>
        </div>
        <ul className="timeline timeline-vertical timeline-compact">
          <li>
            ...
            <div className="timeline-end timeline-box">Harry Potter and Sorcerer's Stack</div>
          ...
          <li>
            ...
            <div className="timeline-end timeline-box">Harry Potter and Chamber of Servers</div>
            <hr className="bg-primary" />
          </li>
          <li>
            <hr className="bg-primary" />
            ...
            <div className="timeline-end timeline-box">Harry Potter and Prisoner of Azure</div>
            <hr className="bg-primary" />
          </li>
          <li>
            <hr className="bg-primary" />
            ...
            <div className="timeline-end timeline-box">Harry Potter and Goblet of Firebase</div>
            <hr />
          </li>
          <li>
            <hr />
            ...
            <div className="timeline-end timeline-box">Harry Potter and Elixir of Phoenix</div>
            <hr />
          </li>
          <li>
            <hr />
            ...
            <div className="timeline-end timeline-box">Harry Potter and Half-Deployed App</div>
            <hr />
          </li>
          <li>
            <hr />
            ...
            <div className="timeline-end timeline-box">Harry Potter and Deathly Frameworks</div>
          </li>
        </ul>
