...
<Overview
  items={[
    { title: 'Install Nivel', href: '/docs/installation' },
    { title: 'Run the quick start', href: '/docs/quick-start' },
    { title: 'Understand the project shape', href: '/docs/project-shape' },
    { title: 'Create a first docs page', href: '/docs/first-docs-page' },
  ]}
/>
