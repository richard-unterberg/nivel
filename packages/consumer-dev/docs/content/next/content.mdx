...
```ts title="app/api/telefunc/route.ts" env="server"
...
```tsx title="app/client-providers.tsx" env="client"
'use client'
...
- <Link href="https://github.com/telefunc/telefunc/blob/main/examples/next"><code>/examples/next</code></Link>
